...
// 该指引插件引用来自： https://github.com/kamranahmedse/driver.js
// 文档说明地址： https://kamranahmed.info/driver.js/
// 新增以下功能：
// 1. 提供是否显示“上一步”，”下一步“ ”关闭“按钮的显示参数
//      showCloseButtons
//      showNextButtons
//      showPrevButtons
// 2. 新增设置宽度功能 width
...
//   onHighlightStarted[callback]: (Element) {}, // Called when element is about to be highlighted
//   onHighlighted[callback]: (Element) {}, // Called when element is fully highlighted
//   onDeselected[callback]: (Element) {}, // Called when element has been deselected
//   onReset[callback]: (Element) {},        // Called when overlay is about to be cleared
//   onNext[callback]: (Element) => {},      // Called when moving to next step on any step
//   onPrevious[callback]: (Element) => {},  // Called when moving to next step on any step
// })
...
//     position: bottom|bottom-left|bottom-right|top-left|top-right
//     onNext[callback]: (Element) => {},      // Called when moving to next step on any step
//     onPrevious[callback]: (Element) => {},  // Called when moving to next step on any step
//   }
// }])
...
export default class Driver {
  ...
  handleNext () {
    ...
    if (currentStep && currentStep.options && currentStep.options.onNext) {
      currentStep.options.onNext(this.overlay.highlightedElement, this.currentStep === this.steps.length - 1);
    }
